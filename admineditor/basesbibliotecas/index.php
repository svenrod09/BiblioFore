...
<head>
    ...
    <title>BiblioFore | Bibliotecas Externas</title>
            ...
            <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 theme-bg">
                <div class="sticky-top d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                    ...
                    <a href="../basesbibliotecas/index.php" class="d-flex align-items-center pb-4 text-decoration-none items-color">
                        <i class="fas fa-book-reader fs-4 fa-fw activo items-color"></i>
                        <span class="ms-2 d-none d-sm-inline activo fw-bold">Bibliotecas Externas</span></a>
                        ...
                        <div class="row justify-content-center align-items-center">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                <h1 class="text-center fw-bold">
                                    <i class="fas fa-book-reader me-2"></i>Control de Bibliotecas Externas
                                </h1>
                            </div>
                        </div>
                    </div>
                        ...
                        <table id="dataTable" class="table table-striped table-bordered table-hover">
                            <thead class="theme-bg">
                                <tr class="text-light">
                                    ...
                                    <th scope="col" class="text-center">Nombre de la Biblioteca</th>
                            ...
                            <tbody>
                                ...
                                try {
                                    ...
                                    $query = "SELECT * FROM basesbibliotecas";
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="#" data-toggle="tooltip" title="Actualizar" data-bs-toggle="modal" data-bs-target="#editarImagenModal" data-id="<?php echo $row['id'] ?>" data-name="<?php echo $row['nombre'] ?>" data-image="<?php echo $row['imagen'] ?>" class="link-dark edit-image tooltip-link"><i class="fas fa-sync-alt fs-5 me-3"></i></a>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="<?php echo $row['enlace'] ?>" target="_blank" data-toggle="tooltip" title="Ir" class="link-dark"><i class="fas fa-arrow-right fs-5 fw-bold me-3"></i></a>
                                                <!-- Ver la URL (al hacer clic se envían a los modal los parámetros necesarios) -->
                                                <a href="#" data-toggle="tooltip" title="Ver" data-bs-toggle="modal" data-bs-target="#verURLModal" data-id="<?php echo $row['id'] ?>" data-name="<?php echo $row['nombre'] ?>" data-url="<?php echo $row['enlace'] ?>" class="link-dark open-url tooltip-link"><i class="fas fa-eye fs-5 me-3"></i></a>
                                            </td>
                                            <td class="text-center">
                                                <!-- Editar (al hacer clic se envían a los modal los parámetros necesarios) -->
                                                <a href="#" data-toggle="tooltip" title="Editar" data-bs-toggle="modal" data-bs-target="#editarModal" data-id="<?php echo $row['id'] ?>" data-name="<?php echo $row['nombre'] ?>" data-url="<?php echo $row['enlace'] ?>" class="link-dark open-edit tooltip-link"><i class="fas fa-edit fs-5 me-3"></i></a>
                                                <!-- Eliminar (al hacer clic se envían a los modal los parámetros necesarios) -->
                                                <a href="#" data-toggle="tooltip" title="Eliminar" data-bs-toggle="modal" data-bs-target="#eliminarModal" data-id="<?php echo $row['id'] ?>" data-name="<?php echo $row['nombre'] ?>" data-image="<?php echo $row['imagen'] ?>" class="link-dark open-delete tooltip-link"><i class="fas fa-trash fs-5 me-3"></i></a>
                                            </td>
                                        </tr>
                                <?php
                                    }
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h5 class="modal-title fw-bold" id="nuevoModalLabel">Nueva Base de Datos de Biblioteca:</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <form id="nuevoRegistroForm" enctype="multipart/form-data">
                                        <div class="mb-3">
                                            <input type="text" class="form-control input-style input-valid" title="Ingrese el nombre de la base de datos de la biblioteca." name="nombreC" id="nombreC" placeholder="Nombre de la base de datos de la biblioteca">
                                        </div>
                                        <div class="mb-3">
                                            <input type="url" class="form-control input-style input-valid" title="Ingrese el URL (enlace) de la base de datos de la biblioteca." name="urlC" id="urlC" placeholder="URL (enlace) de la base de datos de la biblioteca">
                                        </div>
                                        <div class="mb-3">
                                            <label class="fw-bold" for="imgC">Imagen de la biblioteca (10MB máximo):</label>
                                            <input accept="image/png,image/jpeg,image/webp" type="file" class="form-control input-style input-valid" name="imgC" id="imgC" placeholder="Imagen de la biblioteca">
                                        </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h5 class="modal-title fw-bold">Editar Base de Datos de Biblioteca:</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <form id="editarRegistroForm">
                                        <div class="mb-3">
                                            <label class="fw-bold" for="nameE">Nombre de la Biblioteca:</label>
                                            <input type="text" class="form-control input-style input-valid" title="Ingrese el nombre de la base de datos de la biblioteca." name="nombreE" id="nombreE" placeholder="Nombre de la base de datos de la biblioteca">
                                        </div>
                                        <div class="mb-3">
                                            <label class="fw-bold" for="urlE">URL de la Biblioteca:</label>
                                            <input type="url" class="form-control input-style input-valid" title="Ingrese el URL (enlace) de la base de datos de la biblioteca." name="urlE" id="urlE" placeholder="URL (enlace) de la base de datos de la biblioteca">
                                        </div>
                                        <div class="justify-content-center text-center">
                    ...
                    <div class="modal fade" id="editarImagenModal" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <i class="fas fa-edit fs-5 me-2"></i>
                                    <h5 class="modal-title fw-bold">Editar Imagen BD de Biblioteca:</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <form id="editarImagenForm" enctype="multipart/form-data">
                                        <div class="mb-3">
                                            <label class="fw-bold" for="nombreEI">Nombre de la Biblioteca:</label>
                                            <input type="text" class="form-control input-style input-valid" title="Ingrese el nombre de la base de datos de la biblioteca." name="nombreEI" id="nombreEI" placeholder="Nombre de la base de datos de la biblioteca" readonly>
                                        </div>
                                        <div class="mb-3">
                                            <label class="fw-bold" for="imgE">Imagen de la Biblioteca (10MB máximo):</label>
                                            <input accept="image/png,image/jpeg,image/webp" type="file" class="form-control input-style input-valid" name="imgE" id="imgE" placeholder="Imagen de la biblioteca">
                                        </div>
                                        <div class="justify-content-center text-center">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h5 class="modal-title fw-bold">Eliminar Base de Datos de Biblioteca:</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    ¿Realmente deseas eliminar la BD <strong id="name-delete"></strong>?
                                </div>
                                <div class="modal-footer">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h5 class="modal-title fw-bold">Ver URL Base de Datos de Biblioteca:</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <div class="mb-3">
                                    <label class="fw-bold" for="verName">Nombre de la Biblioteca:</label>
                                    <input type="text" name="verName" id="verName" class="form-control input-style input-valid" readonly>
                                </div>
                                <div class="mb-3">
                                    <label class="fw-bold" for="verURL">URL de la Biblioteca:</label>
    ...
    <script>
        $(document).ready(function() {
            ...
            nombreC.addEventListener('input', function() {
                ...
                if (nombreC.value == '' || urlC.value == '' || imgC.files.length == 0) {
