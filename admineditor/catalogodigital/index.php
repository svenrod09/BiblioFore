...
<head>
    ...
    <title>BiblioFore | Catálogo Digital</title>
...
<body>
        ...
        <div class="row flex-nowrap">
            ...
            <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 theme-bg">
                <div class="sticky-top d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                    ...
                    <a href="../catalogodigital/index.php" class="d-flex align-items-center pb-4 text-decoration-none items-color">
                        <i class="fas fa-laptop fs-4 fa-fw activo items-color"></i>
                        <span class="ms-2 d-none d-sm-inline activo fw-bold">Catálogo Digital</span></a>
            ...
            <div id="content-area" class="col py-3">
                <div class="container">
                        ...
                        <div class="row justify-content-center align-items-center">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                <h1 class="text-center fw-bold">
                                    <i class="fas fa-laptop me-2"></i>Control de Catálogo Digital
                                </h1>
                            </div>
                        </div>
                    </div>
                        ...
                        <table id="dataTable" class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                try {
                                    ...
                                    INNER JOIN editoriales e ON md.editorialid = e.id";
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="#" data-toggle="tooltip" title="Actualizar" data-bs-toggle="modal" data-bs-target="#editarArchivoModal" data-id="<?php echo $row['id'] ?>" data-name="<?php echo $row['titulo'] ?>" data-file="<?php echo $row['archivo'] ?>" class="link-dark tooltip-link edit-file"><i class="fas fa-sync-alt fs-5 me-3"></i></a>
                                                <!-- Ver archivo (al hacer clic se envían a los modal los parámetros necesarios) -->
                                                <a href="./<?php echo $row['archivo'] ?>" target="_blank" data-toggle="tooltip" title="Leer" class="link-dark tooltip-link"><i class="fab fa-readme fs-5 me-3"></i></a>
                                                <!-- Descargar archivo (al hacer clic se envían a los modal los parámetros necesarios) -->
                                                <a href="./download.php?file=<?php echo $row['archivo'] ?>" target="_blank" data-toggle="tooltip" title="Descargar" class="link-dark tooltip-link"><i class="fas fa-download fs-5 me-3"></i></a>
                                            </td>
                                            <td class="text-center">
                                                ...
                                                <a href="#" data-toggle="tooltip" title="Eliminar" data-bs-toggle="modal" data-bs-target="#eliminarModal" data-id="<?php echo $row['id'] ?>" data-name="<?php echo $row['titulo'] ?>" data-image="<?php echo $row['imagen'] ?>" data-file="<?php echo $row['archivo'] ?>" class="link-dark open-delete tooltip-link"><i class="fas fa-trash fs-5 me-3"></i></a>
                                            </td>
                                        </tr>
                                <?php
                                    }
                        ...
                        <div class="modal-dialog modal-dialog-scrollable">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h5 class="modal-title fw-bold" id="nuevoModalLabel">Nuevo Material Digital:</h5>
                                ...
                                <div class="modal-body">
                                    <form id="nuevoRegistroForm" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-3">
                                            <label class="fw-bold" for="imgC">Imagen del Material (10 MB máximo):</label>
                                        ...
                                        <div class="mb-3">
                                            <label class="fw-bold" for="fileC">Archivo PDF del Material (500 MB máximo):</label>
                                            <input accept=".pdf" type="file" class="form-control input-style input-valid" name="fileC" id="fileC" placeholder="Archivo PDF del Material">
                                        </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h5 class="modal-title fw-bold">Editar Material Digital:</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                    ...
                    <div class="modal fade" id="editarImagenModal" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <i class="fas fa-edit fs-5 me-2"></i>
                                    <h5 class="modal-title fw-bold">Editar Imagen del Material Digital:</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <form id="editarImagenForm" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-3">
                                            <label class="fw-bold" for="imgE">Imagen del Material (10 MB máximo):</label>
                                        ...
                                        <div class="justify-content-center text-center">
                                            <p id="errormsgEI" class="d-none text-danger fw-bold">Suba un archivo de imagen (10 MB máximo).</p>
                                        </div>
                                        <div class="progress" style="display:none;">
                                            <div class="progress-bar" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                    ...
                    <!-- Modal para Editar Archivo del Registro -->
                    <div class="modal fade" id="editarArchivoModal" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <i class="fas fa-edit fs-5 me-2"></i>
                                    <h5 class="modal-title fw-bold">Editar Archivo del Material Digital:</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <form id="editarArchivoForm" enctype="multipart/form-data">
                                        <div class="mb-3">
                                            <label class="fw-bold" for="nombreEF">Título del Material:</label>
                                            <input type="text" class="form-control input-style input-valid" title="Ingrese el título del material." name="nombreEF" id="nombreEF" placeholder="Título del Material" readonly>
                                        </div>
                                        <div class="mb-3">
                                            <label class="fw-bold" for="fileE">Archivo PDF del Material (500 MB máximo):</label>
                                            <input accept=".pdf" type="file" class="form-control input-style input-valid" name="fileE" id="fileE" placeholder="Archivo/Documento del Material">
                                        </div>
                                        <div class="justify-content-center text-center">
                                            <p id="errormsgEF" class="d-none text-danger fw-bold">Suba un archivo en formato PDF (500 MB máximo).</p>
                                        </div>
                                        <div class="progress" style="display:none;">
                                            <div class="progress-bar" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-danger" data-bs-dismiss="modal"><i class="fas fa-times-circle me-2"></i></i>Cerrar</button>
                                    <button type="button" id="editFile" class="btn btn-dark" disabled><i class="fas fa-save me-2"></i>Guardar</button>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h5 class="modal-title fw-bold">Eliminar Material Digital:</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
    ...
    <script>
        $(document).ready(function() {
            ...
            var fileC = document.getElementById('fileC');
            var fileE = document.getElementById('fileE');
            // Buttons
            ...
            var btnEditarArchivo = document.getElementById('editFile');
            // Mensajes de error
            ...
            var msgErrorEF = document.getElementById('errormsgEF');
            ...
            nombreC.addEventListener('input', function() {
                ...
                if (nombreC.value == '' || descC.value == '' || autorC.value == 0 || tipoC.value == 0 ||
                    editorialC.value == 0 || yearC.value == 0 || imgC.files.length == 0 || fileC.files.length == 0) {
            ...
            fileC.addEventListener('change', function() {
                // Validar que el tamaño del archivo no sea superior a 500MB
                var archivo = this.files[0];
                var maxTamano = 500 * 1024 * 1024; // 500MB
                if (archivo.size > maxTamano) {
                    // El input no es válido, mostrar un mensaje de error
                    this.value = null; // limpiar el valor del input file
                    msgErrorC.classList.remove("d-none");
            ...
            // Validar inputs de modal editar archivo
            fileE.addEventListener('change', function() {
                ...
                if (fileE.files.length == 0) {
                    // El input no es válido, mostrar un mensaje de error
                    msgErrorEF.classList.remove("d-none");
                    btnEditarArchivo.setAttribute("disabled", "");
                }
                // Validar que el tamaño del archivo no sea superior a 500MB 
                else if (archivo.size > maxTamano) {
                    // El input no es válido, mostrar un mensaje de error
                    ...
                    // El input es válido
                    msgErrorEF.classList.add("d-none");
                    btnEditarArchivo.removeAttribute("disabled"); // Activar botón para enviar datos
                }
            });
            ...
            $('.edit-file').click(function() {
                ...
                $('#editFile').click(function() {
                    // Obtener valores
                    var form = document.getElementById("editarArchivoForm");
                    var formData = new FormData(form);
                    formData.append("id", id);
                    formData.append("archivoActual", archivo);
                    ...
                    $.ajax({ // Petición AJAX
                        ...
                        type: "POST", // Método POST
                        url: "updatefile.php", // Archivo que contiene la consulta de inserción
                        data: formData, // Enviar datos
                        dataType: 'json',
                        cache: false,
                        contentType: false,
                        ...
                        success: function(response) {
                            if (response.success) { // Actualización correcta
                                $("#editarArchivoModal").modal("hide"); // Ocultar Modal
                                // Enviar alerta 
                                $("#alertMessage").removeClass("alert-danger");
                                $("#alertMessage").html("¡Correcto! Se actualizó el registro correctamente :D").addClass("alert-success").fadeIn();
                                resetearInput();
