...
try {
    ...
    if (move_uploaded_file($tmp, $path) && !!$archivoActual) {
        // Conexión con la BD
        require_once('../config.php');

        // Consulta de actualización PostgreSQL
        $query = "UPDATE materialdigital SET archivo = :archivo WHERE id = :id";
