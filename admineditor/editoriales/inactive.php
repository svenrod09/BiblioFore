                        ...
                        <table id="dataTable" class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                try {
                                    ...
                                    $query = "SELECT * FROM editoriales WHERE disponible = false";
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h5 class="modal-title fw-bold">Restaurar Editorial:</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    ¿Realmente deseas restaurar la editorial <strong id="name-restore"></strong>?
                                </div>
                    ...
                    <div class="modal fade" id="eliminarModal" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ¿Realmente deseas eliminar de forma permanente la editorial <strong id="name-delete"></strong>?
                                </div>
                                <div class="modal-footer">
