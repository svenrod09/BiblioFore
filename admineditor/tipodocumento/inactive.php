                    ...
                    <div class="container py-2">
                        <div class="row justify-content-center align-items-center">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                <h1 class="text-center fw-bold">Control de Tipos de Documento</h1>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h5 class="modal-title fw-bold">Restaurar Tipo de Documento:</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    ¿Realmente deseas restaurar el tipo de documento <strong id="name-restore"></strong>?
                                </div>
                    ...
                    <div class="modal fade" id="eliminarModal" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ¿Realmente deseas eliminar de forma permanente el tipo de documento <strong id="name-delete"></strong>?
                                </div>
                                <div class="modal-footer">
