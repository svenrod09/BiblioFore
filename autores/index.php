...
<body>
                        ...
                        <table id="dataTable" class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                try {
                                    ...
                                    $query = "SELECT * FROM autores WHERE disponible = true";
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="#" data-toggle="tooltip" title="Editar" data-bs-toggle="modal" data-bs-target="#editarModal" data-id="<?php echo $row['id'] ?>" data-last="<?php echo $row['apellido'] ?>" data-name="<?php echo $row['nombre'] ?>" data-country="<?php echo $row['paisdenacimiento'] ?>" class="link-dark open-edit tooltip-link"><i class="fas fa-edit fs-5 me-3"></i></a>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h5 class="modal-title fw-bold" id="nuevoModalLabel">Nuevo Autor:</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <form id="nuevoRegistroForm">
                                        <div class="mb-3">
                                            <input type="text" class="form-control input-style input-valid" title="Ingrese el nombre del autor." name="nombreC" id="nombreC" placeholder="Nombre del Autor">
                                        </div>
                                        <div class="mb-3">
                                            <input type="text" class="form-control input-style input-valid" title="Ingrese el apellido del autor." name="apellidoC" id="apellidoC" placeholder="Apellido del Autor">
                                        </div>
                                        <div class="justify-content-center text-center">
                                            <p id="errormsgC" class="d-none text-danger fw-bold">Revise los datos ingresados.</p>
                                        </div>
                                        <div class="mb-3">
                                            <label class="fw-bold" for="paisC">País de nacimiento del autor:</label>
                                            <select class="form-select" name="paisC" id="paisC">
                                                <?php include('./paises.php');  ?> <!-- Llena el select con el listado de países -->
                                            </select>
                                        </div>
                                    </form>
                                </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h5 class="modal-title fw-bold">Editar Autor:</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <form id="editarRegistroForm">
                                        <div class="mb-3">
                                            <label class="fw-bold" for="nombreE">Nombre del autor:</label>
                                            <input type="text" class="form-control input-style input-valid" title="Ingrese el nombre del autor." name="nombreE" id="nombreE" placeholder="Nombre del Autor">
                                        </div>
                                        <div class="mb-3">
                                            <label class="fw-bold" for="apellidoE">Apellido del autor:</label>
                                            <input type="text" class="form-control input-style input-valid" title="Ingrese el apellido del autor." name="apellidoE" id="apellidoE" placeholder="Apellido del Autor">
                                        </div>
                                        <div class="justify-content-center text-center">
                                            <p id="errormsgE" class="d-none text-danger fw-bold">Revise los datos ingresados.</p>
                                        </div>
                                        <div class="mb-3">
                                            <label class="fw-bold" for="paisE">País de nacimiento del autor:</label>
                                            <select class="form-select" name="paisE" id="paisE">
                                                <?php include('./paises.php');  ?> <!-- Llena el select con el listado de países -->
                                            </select>
                                        </div>
                                    </form>
                    ...
                    <div class="modal fade" id="eliminarModal" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ¿Realmente deseas eliminar el autor <strong id="name-delete"></strong>?
                                </div>
                                <div class="modal-footer">
    ...
    <script>
        $(document).ready(function() {
            ...
            var apellidoC = document.getElementById('apellidoC');
            var apellidoE = document.getElementById('apellidoE');
            var nombreC = document.getElementById('nombreC');
            var nombreE = document.getElementById('nombreE');
            var paisC = document.getElementById('paisC');
            ...
            apellidoC.addEventListener('input', function() {
                // Validar que el input no esté vacío
                if (nombreC.value == '' || apellidoC.value == '' || paisC.value == 0) {
            ...
            paisC.addEventListener("change", function() {
                // Validar que el input no esté vacío
                if (nombreC.value == '' || apellidoC.value == '' || paisC.value == 0) {
                    // El input no es válido, mostrar un mensaje de error
                    msgErrorC.classList.remove("d-none");
            ...
            apellidoE.addEventListener('input', function() {
                // Validar que el input no esté vacío
                if (nombreE.value == '' || apellidoE.value == '' || paisE.value == 0) {
                    // El input no es válido, mostrar un mensaje de error
            ...
            $("#submit").click(function() {
                ...
                var pais = document.getElementById("paisC");
                var paisdenacimiento = pais.value;
            ...
            $('.open-edit').click(function() {
                ...
                $('#edit').click(function() {
                    ...
                    var paisdenacimiento = $("#paisE").val();
                    $.ajax({ // Petición AJAX
                        type: "POST", // Método POST
