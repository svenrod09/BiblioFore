...
<head>
    ...
    <title>BiblioFore | Tipos de Documento</title>
            ...
            <div class="sticky-top col-auto col-md-3 col-xl-2 px-sm-2 px-0 theme-bg">
                <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                    ...
                    <a href="../tipodocumento/index.php" class="d-flex align-items-center pb-4 text-decoration-none items-color">
                        ...
                        <span class="ms-2 d-none d-sm-inline activo fw-bold">Tipos</span></a>
                        ...
                        <div class="row justify-content-center align-items-center">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                <h1 class="text-center fw-bold">
                                    <i class="fas fa-file me-2"></i>Control de Tipos de Documento
                                </h1>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h5 class="modal-title fw-bold" id="nuevoModalLabel">Nuevo Tipo de Documento:</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <form id="nuevoRegistroForm">
                                        <div class="mb-3">
                                            <label class="fw-bold" for="tipoC">Nombre del Tipo de Documento:</label>
                                            <input type="text" class="form-control input-style input-valid" title="Ingrese el nombre del tipo de documento (Ejemplo: Revista, Libro, etc.)." name="tipoC" id="tipoC" placeholder="Tipo de Documento">
                                        </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h5 class="modal-title fw-bold">Editar Tipo de Documento:</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <form id="editarRegistroForm">
                                        <div class="mb-3">
                                            <label class="fw-bold" for="tipoE">Nombre del Tipo de Documento:</label>
                                            <input type="text" class="form-control input-style" title="Ingrese el nombre del tipo de documento (Ejemplo: Revista, Libro, etc.)." name="tipoE" id="tipoE" placeholder="Tipo de Documento">
                                        </div>
                                        <div class="justify-content-center text-center">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h5 class="modal-title fw-bold">Eliminar Tipo de Documento:</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    ¿Realmente deseas eliminar el tipo <strong id="name-delete"></strong>?
                                </div>
                                <div class="modal-footer">
