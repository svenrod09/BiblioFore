...
<head>
    ...
    <title>Biblioteca | Bibliotecas Externas</title>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="collapsibleNavbar">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link activo" href="../basesbibliotecas/index.php">
        ...
        <div class="row mt-5">
            ...
            <div class="col-12 mt-3 mt-md-0 mb-3">
                <h1 class="text-center fw-bold">
                    <i id="icon-header" class="fas fa-book-reader fa-fw me-2"></i>Bibliotecas Externas
                </h1>
            </div>
        </div>
            ...
            <div class="col-12 col-md-4 order-1 order-md-2 mb-3">
                ...
                <div class="list-group mb-3">
                    <a href="#" id="order" class="list-group-item active-list fw-bold">
                        ...
                        <span class="ms-2">Nombre de la Biblioteca</span>
                    </a>
                </div>
            </div>
        </div>
        ...
        $(document).ready(function() {
            ...
            ordenarButton.addEventListener('click', function() {
                if (ascendente === true) {
                    ...
                    xhttp.open("GET", "./desc.php", true); // Archivo que contiene la consulta 
            ...
            function ordenarASC() {
                ...
                xhttp.open("GET", "./asc.php", true); // Archivo que contiene la consulta (Ascendente)
                xhttp.send(); // Realizar la petición
            }
