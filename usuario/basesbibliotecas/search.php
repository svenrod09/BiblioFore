...
<div id="contenido" class="row justify-content-center">
    ...
    try {
        ...
        $query = "SELECT * FROM public.basesbibliotecas WHERE LOWER(nombre) LIKE :searchTerm ORDER BY nombre ASC";
                        ...
                        <a href="<?php echo $row['enlace'] ?>" target="_blank" class="list-group-item">
                            <div class="row">
                                ...
                                <div class="col-7 mt-3">
                                    <div class="container">
                                        <h5 class="fw-bold"><?php echo markSearch($row['nombre'], $searchTerm); ?></h5>
                                    </div>
                                </div>
