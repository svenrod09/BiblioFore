...
<div id="contenido" class="row justify-content-center">
    ...
    try {
        // Obtener la columna y categoría por la que se ordenarán los datos 
        $column = $_GET['column'];
        ...
        INNER JOIN editoriales e ON md.editorialid = e.id WHERE md.tipodocumentoid = :category ORDER BY $column DESC, titulo ASC";
