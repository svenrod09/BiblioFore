...
<div id="contenido" class="row justify-content-center">
    ...
    try {
        ...
        $query = "SELECT DISTINCT au.id as id, CONCAT(au.nombre, ' ', au.apellido) as autor FROM materialdigital md INNER JOIN autores au 
        ON md.autorid = au.id WHERE md.tipodocumentoid = :category ORDER BY autor ASC";
