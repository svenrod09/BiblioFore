...
<div id="contenido" class="row justify-content-center">
    ...
    try {
        ...
        $query = "SELECT DISTINCT au.id, CONCAT(au.nombre, ' ', au.apellido) as autor FROM materialdigital md INNER JOIN autores au 
        ON md.autorid = au.id WHERE au.paisdenacimiento = :id AND md.tipodocumentoid = :category ORDER BY autor ASC";
    ...
    ?>
            <div class="col-12 mb-3">
                <div class="list-group">
                    ...
                    ?>
                        <a href="#" data-id="<?php echo $row['id'] ?>" data-folder="autores" data-file="byautor" class="list-group-item filtrardatos">
                            <div class="row">
                                <div class="col-10 mt-2">
                                    <div class="container">
                                        <p><span class="fw-bold"><?php echo $row['autor'] ?></span></p>
                                    </div>
                                </div>
