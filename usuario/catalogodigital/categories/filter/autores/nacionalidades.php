...
<div id="contenido" class="row justify-content-center">
    ...
    try {
        ...
        $query = "SELECT DISTINCT au.id as id, au.paisdenacimiento FROM materialdigital md INNER JOIN autores au 
        ON md.autorid = au.id WHERE md.tipodocumentoid = :category ORDER BY paisdenacimiento ASC";
    ...
    ?>
            <div class="col-12 mb-3">
                <div class="list-group">
                    ...
                    ?>
                        <a href="#" data-id="<?php echo $row['paisdenacimiento'] ?>" data-folder="autores" data-file="bynacionalidad" class="list-group-item filtrardatos h-100">
                            <div class="row">
                                <div class="col-10 mt-2">
                                    <div class="container">
                                        <p><span class="fw-bold"><?php echo $row['paisdenacimiento'] ?></span></p>
                                    </div>
                                </div>
