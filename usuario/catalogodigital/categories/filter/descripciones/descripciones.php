...
<div id="contenido" class="row justify-content-center">
    ...
    try {
        ...
        $query = "SELECT DISTINCT descripcion FROM materialdigital md WHERE md.tipodocumentoid = :category ORDER BY descripcion ASC";
    ...
    ?>
            <div class="col-12 mb-3">
                <div class="list-group">
                    ...
                    ?>
                        <a href="#" data-id="<?php echo $row['descripcion'] ?>" data-folder="descripciones" data-file="bydescripcion" class="list-group-item filtrardatos h-100">
                            <div class="row">
                                <div class="col-10 mt-2">
                                    <div class="container">
                                        <p><span class="fw-bold"><?php echo $row['descripcion'] ?></span></p>
                                    </div>
                                </div>
