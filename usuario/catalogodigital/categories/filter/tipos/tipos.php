...
<div id="contenido" class="row justify-content-center">
    ...
    try {
        ...
        $query = "SELECT DISTINCT td.id, td.nombre FROM materialdigital md INNER JOIN tipodocumento td ON
        md.tipodocumentoid = td.id WHERE md.tipodocumentoid = :category ORDER BY nombre ASC";
    ...
    ?>
            <div class="col-12 mb-3">
                <div class="list-group">
                    ...
                    ?>
                        <a href="#" data-id="<?php echo $row['id'] ?>" data-folder="tipos" data-file="bytipo" class="list-group-item filtrardatos h-100">
                            <div class="row">
