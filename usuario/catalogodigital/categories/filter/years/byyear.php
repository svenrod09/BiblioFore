...
<div id="contenido" class="row justify-content-center">
    ...
    try {
        ...
        INNER JOIN editoriales e ON md.editorialid = e.id WHERE md.emisionyear = :id AND md.tipodocumentoid = :category ORDER BY titulo ASC";
                            ...
                            <div class="row">
                                ...
                                <div class="col-7 mt-2">
                                    <div class="container">
                                        ...
                                        <p><span class="fw-bold">Año de emisión: </span><span class="bg-warning text-dark"><?php echo $row['year'] ?></span></p>
                                    </div>
                                </div>
