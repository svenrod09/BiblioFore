...
<div id="contenido" class="row justify-content-center">
    ...
    try {
        ...
        $query = "SELECT DISTINCT emisionyear FROM materialdigital md WHERE md.tipodocumentoid = :category
        ORDER BY emisionyear DESC";
    ...
    ?>
            <div class="col-12 mb-3">
                <div class="list-group">
                    ...
                    ?>
                        <a href="#" data-id="<?php echo $row['emisionyear'] ?>" data-folder="years" data-file="byyear" class="list-group-item filtrardatos h-100">
                            <div class="row">
                                <div class="col-10 mt-2">
                                    <div class="container">
                                        <p><span class="fw-bold"><?php echo $row['emisionyear'] ?></span></p>
                                    </div>
                                </div>
