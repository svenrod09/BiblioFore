...
<div id="contenido" class="row justify-content-center">
    ...
    try {
        ...
        $query = "SELECT DISTINCT au.id as id, CONCAT(au.nombre, ' ', au.apellido) as autor FROM materialfisico mf INNER JOIN autores au 
        ON mf.autorid = au.id WHERE mf.tipodocumentoid = :category ORDER BY autor ASC";
