...
<div id="contenido" class="row justify-content-center">
    ...
    try {
        ...
        $query = "SELECT DISTINCT au.id, CONCAT(au.nombre, ' ', au.apellido) as autor FROM materialfisico mf INNER JOIN autores au 
        ON mf.autorid = au.id WHERE au.paisdenacimiento = :id AND mf.tipodocumentoid = :category ORDER BY autor ASC";
