...
<div id="contenido" class="row justify-content-center">
    ...
    try {
        ...
        INNER JOIN editoriales e ON mf.editorialid = e.id WHERE mf.descripcion = :id AND mf.tipodocumentoid = :category ORDER BY titulo ASC";
    ...
    ?>
            <div class="col-12 mb-3">
                <div class="list-group">
                    <p><span><a href="#" id=resetFilter><i class="fas fa-arrow-left fs-2 text-dark me-2"></i></a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-7 mt-2">
                                            <div class="container">
                                                ...
                                                <p><span class="fw-bold">Descripción: </span><span class="bg-warning text-dark"><?php echo $row['descripcion'] ?></span></p>
