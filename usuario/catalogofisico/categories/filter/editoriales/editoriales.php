...
<div id="contenido" class="row justify-content-center">
    ...
    try {
        ...
        $query = "SELECT DISTINCT e.id, e.nombre FROM materialfisico mf INNER JOIN editoriales e ON
        mf.editorialid = e.id WHERE mf.tipodocumentoid = :category ORDER BY nombre ASC";
