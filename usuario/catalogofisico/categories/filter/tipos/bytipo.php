...
<div id="contenido" class="row justify-content-center">
    ...
    try {
        ...
        INNER JOIN editoriales e ON mf.editorialid = e.id WHERE mf.tipodocumentoid = :id AND mf.tipodocumentoid = :category ORDER BY titulo ASC";
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-7 mt-2">
                                            <div class="container">
                                                ...
                                                <p><span class="fw-bold">Categoría: </span><span class="bg-warning text-dark"><?php echo $row['tipo'] ?></span></p>
