...
<div id="contenido" class="row justify-content-center">
    ...
    try {
        ...
        $query = "SELECT DISTINCT td.id, td.nombre FROM materialfisico mf INNER JOIN tipodocumento td ON
        mf.tipodocumentoid = td.id WHERE mf.tipodocumentoid = :category ORDER BY nombre ASC";
