...
<div id="contenido" class="row justify-content-center">
    ...
    try {
        ...
        INNER JOIN editoriales e ON mf.editorialid = e.id WHERE mf.emisionyear = :id AND mf.tipodocumentoid = :category ORDER BY titulo ASC";
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-7 mt-2">
                                            <div class="container">
                                                ...
                                                <p><span class="fw-bold">Año de emisión: <span class="bg-warning text-dark"><?php echo $row['year'] ?></span></p>
                                            </div>
                                        </div>
