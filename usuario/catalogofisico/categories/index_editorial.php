            ...
            <div class="col-12 col-md-4 order-1 order-md-2 mb-3">
                ...
                <div class="list-group mb-3">
                    ...
                    <a href="#" id="order" class="list-group-item active-list fw-bold">
                        ...
                        <span class="ms-2">Editorial</span>
                    </a>
                    <a href="./index_year.php?cat=<?php echo $category; ?>&name=<?php echo $name; ?>" class="list-group-item fw-bold">
        ...
        $(document).ready(function() {
            ...
            ordenarButton.addEventListener('click', function() {
                if (ascendente === true) {
                    ...
                    var columna = "editorial"; // Columna de la BD por la que se desea ordenar los datos
