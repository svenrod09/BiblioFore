...
if (!isset($_SESSION['user'])) { // Si no existen credenciales de la sesión
    ...
    header("Location: https://biblio.unacifor.edu.hn/usuario/userPage.php"); // Redirigir al usuario a la página de inicio
    exit;
} else {
    $user = $_SESSION['user']; // Nombre de usuario
    $category = $_GET['cat']; // Categoría del material
    $name = $_GET['name']; // Nombre de categoría del material
}
?>
...
<head>
    ...
    <title>Biblioteca | Catálogo Físico</title>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="collapsibleNavbar">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle activo" href="#" id="navbarDropdown1" role="button" data-bs-toggle="dropdown" aria-expanded="false">
        ...
        <div class="row mt-5">
            ...
            <div class="col-12 mt-3 mt-md-0 mb-3">
                <h1 class="text-center fw-bold">
                    <i id="icon-header" class="fas fa-book fa-fw me-2"></i>Catálogo Físico:
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-4 order-1 order-md-2 mb-3">
                ...
                <div class="list-group mb-3">
                    <a href="./index.php?cat=<?php echo $category; ?>&name=<?php echo $name; ?>" class="list-group-item fw-bold">
                        <span>Título</span>
                    </a>
                    <a href="./index_autor.php?cat=<?php echo $category; ?>&name=<?php echo $name; ?>" class="list-group-item fw-bold">
                        <span>Autor</span>
                    </a>
                    <a href="./index_descripcion.php?cat=<?php echo $category; ?>&name=<?php echo $name; ?>" class="list-group-item fw-bold">
                        <span>Descripción</span>
                    </a>
                    <a href="./index_categoria.php?cat=<?php echo $category; ?>&name=<?php echo $name; ?>" class="list-group-item fw-bold">
                        <span>Categoría</span>
                    </a>
                    <a href="./index_editorial.php?cat=<?php echo $category; ?>&name=<?php echo $name; ?>" class="list-group-item fw-bold">
                        <span>Editorial</span>
                    </a>
                    <a href="#" id="order" class="list-group-item active-list fw-bold">
                        <i id="ordericon" class="fas fa-arrow-up"></i>
                        <span class="ms-2">Año de Emisión</span>
                    </a>
                </div>
        ...
        $(document).ready(function() {
            ...
            ordenarButton.addEventListener('click', function() {
                if (ascendente === true) {
                    ...
                    var columna = "year"; // Columna de la BD por la que se desea ordenar los datos
                    var contenidoDiv = document.getElementById('contenido'); // Div que aloja el contenido 
                    var categoria = "<?php echo $category; ?>"; // Categoría del material
                    ...
                    xhttp.open("GET", "./desc.php?column=" + encodeURIComponent(columna) + "&category=" + encodeURIComponent(categoria), true); // Archivo que contiene la consulta 
            ...
            function ordenarASC() {
                ...
                xhttp.open("GET", "./asc.php?column=" + encodeURIComponent(columna) + "&category=" + encodeURIComponent(categoria), true); // Archivo que contiene la consulta (Ascendente)
                xhttp.send(); // Realizar la petición
            }
            ...
            function busqueda() {
                ...
                xhr.send('search-term=' + encodeURIComponent(searchTerm) + '&category=' + encodeURIComponent(categoria)); // Asigna el término de búsqueda y realiza la petición
            }
            ...
            function filtro(filtro) { // Parámetro que contiene la carpeta y el archivo donde se aloja la consulta de filtrado
                ...
                xhttp.open("GET", "./filter/" + filtro + "/" + filtro + ".php?category=" + encodeURIComponent(categoria), true); // Archivo que contiene la consulta 
                xhttp.send(); // Realizar la petición
            }
            ...
            function filtroDoble(carpeta, filtro) { // Parámetro que contiene la carpeta y el archivo donde se aloja la consulta de filtrado
                ...
                xhttp.open("GET", "./filter/" + carpeta + "/" + filtro + ".php?category=" + encodeURIComponent(categoria), true); // Archivo que contiene la consulta 
                xhttp.send(); // Realizar la petición
            }
            ...
            function filtrarData(id, carpeta, archivo) {
                ...
                xhttp.open("GET", "./filter/" + carpeta + "/" + archivo + ".php?id=" + encodeURIComponent(id) + "&category=" + encodeURIComponent(categoria), true); // Archivo que contiene la consulta 
                xhttp.send(); // Realizar la petición
            }
        });
    </script>
