...
<div id="contenido" class="row justify-content-center">
    ...
    try {
        ...
        INNER JOIN editoriales e ON mf.editorialid = e.id WHERE LOWER(mf.titulo) LIKE :searchTerm OR LOWER(CONCAT(au.nombre, ' ', au.apellido)) 
        LIKE :searchTerm OR LOWER(mf.descripcion) LIKE :searchTerm OR LOWER(td.nombre) LIKE :searchTerm OR LOWER(e.nombre) LIKE :searchTerm 
        OR LOWER(td.nombre) LIKE :searchTerm OR mf.emisionyear LIKE :searchTerm AND mf.tipodocumentoid = :category ORDER BY titulo ASC";
    ...
    ?>
            <div class="col-12 mb-3">
                <div class="list-group">
                    <p><span><a href="#" id=resetSearch><i class="fas fa-arrow-left fs-2 text-dark me-2"></i></a>Mostrando <span class="badge theme-bg fw-bold"><?php echo $stmt->rowCount(); ?></span> resultados.</p>
                    <?php
