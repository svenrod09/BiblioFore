        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="collapsibleNavbar">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="../catalogodigital/index.php">
                            <i class="fas fa-laptop fs-5 fa-fw"></i>
                            <span class="ms-2 fs-5 fw-bold">Catálogo Digital</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link activo" href="../catalogofisico/index.php">
        ...
        $(document).ready(function() {
            ...
            $('#filterSelect').on('change', function() {
                ...
                if (opcion === '0') { // Filtrado por defecto
                    ...
                    filtro(carpeta); // Filtra los datos
                } else if (opcion === '4') { // Filtrado por tipo de documento
                    var carpeta = "tipos";
                    filtro(carpeta); // Filtra los datos
            ...
            // Al hacer click en el botón de reiniciar ordena los datos de forma ascendente dependiendo de la columna por la que se esté ordenando (A-Z)
            ...
            // Al hacer click en el botón de reiniciar limpia el input de búsqueda y ordena los datos de forma ascendente dependiendo de la columna por la que se esté ordenando (A-Z)
            $('#resetSearch').click(function() {
                ascendente = true; // Ordenar los datos de forma ascendente
                $('#filterSelect').val("0"); // Reinicia los filtros
                $('#search').val(""); // Limpia los valores del input de búsqueda
                ordenarIcon.classList.remove('fa-arrow-up'); // Cambia el ícono de ordenamiento
                ordenarIcon.classList.remove('fa-arrow-down'); // Cambia el ícono de ordenamiento
                ordenarIcon.classList.add('fa-arrow-up'); // Cambia el ícono de ordenamiento
                ordenarASC(); // Ordenar los datos de forma ascendente
