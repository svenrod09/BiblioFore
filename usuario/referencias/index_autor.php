...
<head>
    ...
    <title>Biblioteca | Referencias Externas</title>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="collapsibleNavbar">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link activo" href="../referencias/index.php">
        ...
        <div class="row mt-5">
            ...
            <div class="col-12 mt-3 mt-md-0 mb-3">
                <h1 class="text-center fw-bold">
                    <i id="icon-header" class="fas fa-quote-right fa-fw me-2"></i>Referencias Externas
                </h1>
            </div>
        </div>
